...
class Bluez extends EventEmitter {
    ...
    async getAdapter(dev) {
        if (dev) {
            ...
            return this.getInterfaceInstance(dev, Adapter.INTERFACE_NAME, Adapter);
        }
    ...
    getDevice(address) {
        ...
        return this.findInterfaceInstance(Device.INTERFACE_NAME, Device, (d) => d.Address === address);
    }
    /**
