    ...
    */
    ...
    async onInterfacesAdded(path, interfaces) {
        ...
        if ('org.bluez.GattService1' in interfaces) {
            ...
            if (!this.services[props.UUID]) {
                this.services[props.UUID] = [service];
            } else {
                this.services[props.UUID].push(service);
            }
        ...
        if ('org.bluez.GattCharacteristic1' in interfaces) {
            ...
            const changed = this.getInterface('org.bluez', path, 'org.freedesktop.DBus.Properties');
